...
def main() -> int:
    ...
    env2 = JSpaceEnv(agent_id="eval-swap")
    ...
    env3 = JSpaceEnv(agent_id="eval-inj")
    ...
    env4 = JSpaceEnv(agent_id="eval-abl")
    ...
    env5 = JSpaceEnv(agent_id="eval-ref")
    ...
    results.append(
        _pass(
            ...
            bool(out.report) and "J-Space" in (out.context or "") and not out.skipped,
        )
    )
